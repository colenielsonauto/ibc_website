...
export default function Home() {
  ...
  return (
    <Container>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md p-6 h-full transition-transform group-hover:scale-105">
              <div className="flex items-center mb-4">
                <div className="bg-[#0a2966]/10 dark:bg-[#0a2966]/20 p-3 rounded-lg mr-4">
                  <svg className="w-6 h-6 text-[#0a2966] dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex flex-wrap items-center justify-between w-full max-w-4xl gap-5 mx-auto text-white bg-[#0a2966]/90 px-7 py-7 lg:px-12 lg:py-12 lg:flex-nowrap rounded-xl mt-10">
